...
# Local, non-instanceable copies of the four Factory gear USDs, generated by
# ``scripts/tools/make_gear_usds_uninstanceable.py``. We use local copies so
# that the ``bind_slippery_gear_material`` startup event can actually apply
# the slippery + compliant material -- USD won't let you bind to instance
# proxies, which is the form these gears ship in on Nucleus.
_GEAR_ASSETS_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "assets")
...
class GearAssemblySceneCfg(InteractiveSceneCfg):
    ...
    held_asset: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=os.path.join(_GEAR_ASSETS_DIR, "factory_gear_large.usd"),
    ...
    gear_small: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=os.path.join(_GEAR_ASSETS_DIR, "factory_gear_small.usd"),
    ...
    gear_medium: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=os.path.join(_GEAR_ASSETS_DIR, "factory_gear_medium.usd"),
            activate_contact_sensors=False,
            rigid_props=_gear_rigid_props(kinematic=False),
            collision_props=_gear_collision_props(),
        ),
    ...
    fixed_asset: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=os.path.join(_GEAR_ASSETS_DIR, "factory_gear_base.usd"),
            activate_contact_sensors=True,
